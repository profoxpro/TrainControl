 ...
 */
public class UDPNetworkProxy implements NetworkProxy
{
     ...
     */
    public UDPNetworkProxy(String transmitIP) throws IOException
    {

        this.socket = new DatagramSocket(UDPNetworkProxy.RX_PORT);
        this.transmitIP = InetAddress.getByName(transmitIP);
        this.transmitPort = UDPNetworkProxy.TX_PORT;
    }
    ...
    public void start()
    {
       model.log("Starting UDP network proxy.");
    };

    @Override
    public void shutdown()
    {
        model.log("Shutting down UDP network proxy.");
    };
